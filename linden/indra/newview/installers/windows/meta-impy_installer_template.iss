...
AppPublisher=The meta-impy Project
...
[Files]
Source: %%PACKAGEFILES%%\meta-impy.exe; DestDir: {app}; Flags: ignoreversion
...
Source: %%PACKAGEFILES%%\meta-impy.url; DestDir: {app}; Flags: ignoreversion
...
Filename: {app}\meta-impy.url; WorkingDir: {app}; Flags: nowait postinstall shellexec; Description: See what makes meta-impy different
...
Name: {app}\meta-impy.exe.config; Type: files; Tasks: ; Languages:
